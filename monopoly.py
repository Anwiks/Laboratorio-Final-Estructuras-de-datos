...
class Jugador(object):
    ...
    def __init__(self, nombre):
        if len(Jugador.lista_de_jugadores) == Jugador.max_de_jugadores:
            ...
            self.cuadro_actual = None # pone el cuadro a empezar 
...
class Juego(object):
    ...
    def __init__(self):
        ...
        self.main() # Empieza el juego principal
    ...
    def empezar_turno_de_jugador(self):
        ...
        elif True==False: #si jugador a perdido
            pass
        else:
            while True:
                print("\n", "Menu de jugador:")
